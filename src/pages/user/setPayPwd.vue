...
<style>
	...
	.setPayPwd-container ul{
		margin: 0 auto;
		width: 6.9rem;
		display: flex;
		height: 1.16rem;
	}
	.setPayPwd-container ul li{
		flex:1;
		display: flex;
		align-items: center;
	...
	.setPayPwd-container ul li span{
		display: block;
		width: .2rem;
		height: .2rem;
		border-radius: .1rem;
	...
	.setPayPwd-container ul li.active span{
		background-color: #000;
	}
	.setPayPwd-container ul li:after{
		border-right: 0;
	}
	.setPayPwd-container ul .last-child:after{
